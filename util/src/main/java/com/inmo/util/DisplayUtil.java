...
//    private static final String TAG = DisplayUtil.class.getSimpleName();
     ...
     * 是否有Mic
     */
    private static Boolean sHasMic = null;
    ...
    public static final boolean hasMic(Context context) {
        if (sHasMic == null) {
            PackageManager pckMgr = context.getPackageManager();
            boolean micPresent = pckMgr.hasSystemFeature("android.hardware.microphone");
            sHasMic = micPresent;
        }
        return sHasMic;
    }
